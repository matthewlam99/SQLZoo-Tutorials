...
SELECT DISTINCT stadium, COUNT(stadium) FROM game JOIN goal ON (id=matchid)
GROUP BY stadium
...
SELECT DISTINCT matchid, mdate, COUNT(teamid)FROM game JOIN goal ON (matchid = id) 
